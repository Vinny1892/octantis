...
| 004 | [Octantis Helm Chart — Modular Deployment](prd-004-helm-chart.md) | Create a modular Helm chart for Octantis with toggleable components (OTel Collector, OTel Operator, Grafana MCP, K8s MCP) published to ghcr.io and ArtifactHub | media | medium | Vinicius Espindola | helm, kubernetes, deployment, distribution, otel, mcp | 2026-04-10 |
